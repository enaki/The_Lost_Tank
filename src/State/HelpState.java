...
public class HelpState extends State {
    ...
    public void render(Graphics g) {
        ...
        drawTankTypes(g, handler.getWidth()-450, 130);
        drawCredits(g, handler.getWidth()-450, 400 );
        //drawCredits(g, 10, 500 );
    }
    ...
    private void drawTankTypes(Graphics g, int x, int y) {
        //Chest Types
        Font fnt1 = new Font("Comic Sans MS", Font.BOLD, 25);
        Font fnt2 = new Font("Comic Sans MS", Font.BOLD, 13);

        g.setColor(Color.CYAN);
        g.setFont(fnt1);
        g.drawString("Tank Types", x, y);

        g.setColor(Color.white);
        g.setFont(fnt2);
        g.drawString("Tank", x , y+70);
        g.drawString("Health", x , y+110);
        g.drawString("Speed", x , y+140);
        g.drawString("FireRate", x , y+170);
        g.drawString("Bullet", x , y+200);

        int width = 48;
        int height = 48;
        g.drawImage(Assets.tank_1[0], x+50, y + 35, width, height, null);
        drawTankProperties(g,  x+65, y + 110, tank_1);
        g.drawImage(Assets.bullet_1[0], x+65, y + 190, 16, 16, null );

        g.drawImage(Assets.tank_2[0], x+100, y + 35, width, height, null);
        drawTankProperties(g,  x+115, y + 110, tank_2);
        g.drawImage(Assets.bullet_2[0], x+115, y + 190, 16, 16, null );

        g.drawImage(Assets.tank_3[0], x+150, y + 35, width, height, null);
        drawTankProperties(g,  x+165, y + 110, tank_3);
        g.drawImage(Assets.bullet_3[0], x+165, y + 190, 16, 16, null );

        g.drawImage(Assets.tank_4[0], x+200, y + 35, width, height, null);
        drawTankProperties(g,  x+215, y + 110, tank_4);
        g.drawImage(Assets.bullet_4[0], x+210, y + 190, 16, 16, null );
        g.drawImage(Assets.bullet_4[0], x+220, y + 190, 16, 16, null );

        g.drawImage(Assets.player_level_1[0], x+250, y + 35, width, height, null);
        drawTankProperties(g,  x+265, y + 110, player_level_1);
        g.drawImage(Assets.bullet_2[0], x+265, y + 190, 16, 16, null );

        g.drawImage(Assets.player_level_2[0], x+300, y + 35, width, height, null);
        drawTankProperties(g,  x+315, y + 110, player_level_2);
        g.drawImage(Assets.bullet_3[0], x+315, y + 190, 16, 16, null );
        g.drawImage(Assets.bullet_5[0], x+305, y + 190, 16, 16, null );
        g.drawImage(Assets.bullet_5[0], x+325, y + 190, 16, 16, null );

        g.drawImage(Assets.robot[1][3], x+350, y + 35 - 16, 64, 64, null);
        drawTankProperties(g,  x+365, y + 110, robot);
        g.drawImage(Assets.bullet_5[0], x+365, y + 190, 16, 16, null );
    ...
    private void drawCredits(Graphics g, int x, int y){
        Font fnt1 = new Font("Courier New", Font.BOLD, 12);
        g.setFont(fnt1);
        g.setColor(Color.orange);
        g.drawString("Proiect realizat de Enachi Vasile", x , y);
        g.drawString("An II AC CTI Grupa 1208B ", x , y+20);
        g.drawString("Evaluator : Robert Lupu", x , y+40);
